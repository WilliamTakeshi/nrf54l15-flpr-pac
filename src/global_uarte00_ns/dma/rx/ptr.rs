...
#[doc = "Field `PTR` reader - RAM buffer start address for this EasyDMA channel. This address is a word aligned Data RAM address."]
pub type PtrR = crate::FieldReader<u32>;
#[doc = "Field `PTR` writer - RAM buffer start address for this EasyDMA channel. This address is a word aligned Data RAM address."]
...
#[doc = "`reset()` method sets PTR to value 0x2000_0000"]
