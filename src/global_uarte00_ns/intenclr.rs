...
#[doc = "Write '1' to disable interrupt for event FRAMETIMEOUT\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `FRAMETIMEOUT` reader - Write '1' to disable interrupt for event FRAMETIMEOUT"]
...
#[doc = "Field `FRAMETIMEOUT` writer - Write '1' to disable interrupt for event FRAMETIMEOUT"]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn clear(self) -> &'a mut crate::W<REG> {
        self.variant(FrametimeoutWO::Clear)
    }
}
impl R {
    ...
    #[doc = "Bit 3 - Write '1' to disable interrupt for event TXDRDY"]
    #[inline(always)]
    pub fn txdrdy(&self) -> TxdrdyR {
        TxdrdyR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - Write '1' to disable interrupt for event RXDRDY"]
    #[inline(always)]
    ...
    #[doc = "Bit 9 - Write '1' to disable interrupt for event RXTO"]
    #[inline(always)]
    pub fn rxto(&self) -> RxtoR {
        RxtoR::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 12 - Write '1' to disable interrupt for event TXSTOPPED"]
    #[inline(always)]
    ...
    #[doc = "Bit 29 - Write '1' to disable interrupt for event FRAMETIMEOUT"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 12 - Write '1' to disable interrupt for event TXSTOPPED"]
    #[inline(always)]
    pub fn txstopped(&mut self) -> TxstoppedW<'_, IntenclrSpec> {
    ...
    #[doc = "Bit 29 - Write '1' to disable interrupt for event FRAMETIMEOUT"]
    #[inline(always)]
    pub fn frametimeout(&mut self) -> FrametimeoutW<'_, IntenclrSpec> {
