...
#[repr(u32)]
pub enum Baudrate {
    #[doc = "323584: 1200 baud (actual rate: 1205) when UARTE has 16 MHz peripheral clock frequency"]
    Baud1200 = 323584,
    #[doc = "643072: 2400 baud (actual rate: 2396) when UARTE has 16 MHz peripheral clock frequency"]
    Baud2400 = 643072,
    #[doc = "1290240: 4800 baud (actual rate: 4808) when UARTE has 16 MHz peripheral clock frequency"]
    Baud4800 = 1290240,
    #[doc = "2576384: 9600 baud (actual rate: 9598) when UARTE has 16 MHz peripheral clock frequency"]
    Baud9600 = 2576384,
    #[doc = "3862528: 14400 baud (actual rate: 14401) when UARTE has 16 MHz peripheral clock frequency"]
    Baud14400 = 3862528,
    #[doc = "5152768: 19200 baud (actual rate: 19208) when UARTE has 16 MHz peripheral clock frequency"]
    Baud19200 = 5152768,
    #[doc = "7716864: 28800 baud (actual rate: 28777) when UARTE has 16 MHz peripheral clock frequency"]
    Baud28800 = 7716864,
    #[doc = "8388608: 31250 baud when UARTE has 16 MHz peripheral clock frequency"]
    Baud31250 = 8388608,
    #[doc = "10289152: 38400 baud (actual rate: 38369) when UARTE has 16 MHz peripheral clock frequency"]
    Baud38400 = 10289152,
    #[doc = "15007744: 56000 baud (actual rate: 55944) when UARTE has 16 MHz peripheral clock frequency"]
    Baud56000 = 15007744,
    #[doc = "15400960: 57600 baud (actual rate: 57554) when UARTE has 16 MHz peripheral clock frequency"]
    Baud57600 = 15400960,
    #[doc = "20615168: 76800 baud (actual rate: 76923) when UARTE has 16 MHz peripheral clock frequency"]
    Baud76800 = 20615168,
    #[doc = "30801920: 115200 baud (actual rate: 115108) when UARTE has 16 MHz peripheral clock frequency"]
    Baud115200 = 30801920,
    #[doc = "61865984: 230400 baud (actual rate: 231884) when UARTE has 16 MHz peripheral clock frequency"]
    Baud230400 = 61865984,
    #[doc = "67108864: 250000 baud when UARTE has 16 MHz peripheral clock frequency"]
    Baud250000 = 67108864,
    #[doc = "121634816: 460800 baud (actual rate: 457143) when UARTE has 16 MHz peripheral clock frequency"]
    Baud460800 = 121634816,
    #[doc = "251658240: 921600 baud (actual rate: 941176) when UARTE has 16 MHz peripheral clock frequency"]
    Baud921600 = 251658240,
    #[doc = "268435456: 1 megabaud when UARTE has 16 MHz peripheral clock frequency"]
    Baud1m = 268435456,
}
