...
#[doc = "Write '1' to enable interrupt for event XOSTARTED\n\nValue on reset: 0"]
...
#[doc = "Field `XOSTARTED` reader - Write '1' to enable interrupt for event XOSTARTED"]
...
#[doc = "Field `XOSTARTED` writer - Write '1' to enable interrupt for event XOSTARTED"]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn set_(self) -> &'a mut crate::W<REG> {
        self.variant(XostartedWO::Set)
    }
}
#[doc = "Write '1' to enable interrupt for event PLLSTARTED\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Pllstarted {
    #[doc = "0: Read: Disabled"]
    Disabled = 0,
...
#[doc = "Field `PLLSTARTED` reader - Write '1' to enable interrupt for event PLLSTARTED"]
...
#[doc = "Field `PLLSTARTED` writer - Write '1' to enable interrupt for event PLLSTARTED"]
...
#[doc = "Write '1' to enable interrupt for event XOTUNED\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Xotuned {
    #[doc = "0: Read: Disabled"]
    Disabled = 0,
...
#[doc = "Field `XOTUNED` reader - Write '1' to enable interrupt for event XOTUNED"]
...
#[doc = "Field `XOTUNED` writer - Write '1' to enable interrupt for event XOTUNED"]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn set_(self) -> &'a mut crate::W<REG> {
        self.variant(XotunedWO::Set)
    }
}
#[doc = "Write '1' to enable interrupt for event XOTUNEERROR\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `XOTUNEERROR` reader - Write '1' to enable interrupt for event XOTUNEERROR"]
...
#[doc = "Field `XOTUNEERROR` writer - Write '1' to enable interrupt for event XOTUNEERROR"]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn set_(self) -> &'a mut crate::W<REG> {
        self.variant(XotuneerrorWO::Set)
    }
}
#[doc = "Write '1' to enable interrupt for event XOTUNEFAILED\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `XOTUNEFAILED` reader - Write '1' to enable interrupt for event XOTUNEFAILED"]
...
#[doc = "Field `XOTUNEFAILED` writer - Write '1' to enable interrupt for event XOTUNEFAILED"]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn set_(self) -> &'a mut crate::W<REG> {
        self.variant(XotunefailedWO::Set)
    }
}
impl R {
...
impl W {
    #[doc = "Bit 0 - Write '1' to enable interrupt for event XOSTARTED"]
    #[inline(always)]
    pub fn xostarted(&mut self) -> XostartedW<'_, IntensetSpec> {
        XostartedW::new(self, 0)
    }
    #[doc = "Bit 1 - Write '1' to enable interrupt for event PLLSTARTED"]
    #[inline(always)]
    pub fn pllstarted(&mut self) -> PllstartedW<'_, IntensetSpec> {
    ...
    #[doc = "Bit 4 - Write '1' to enable interrupt for event XOTUNED"]
    #[inline(always)]
    pub fn xotuned(&mut self) -> XotunedW<'_, IntensetSpec> {
        XotunedW::new(self, 4)
    }
    #[doc = "Bit 5 - Write '1' to enable interrupt for event XOTUNEERROR"]
    #[inline(always)]
    pub fn xotuneerror(&mut self) -> XotuneerrorW<'_, IntensetSpec> {
        XotuneerrorW::new(self, 5)
    }
    #[doc = "Bit 6 - Write '1' to enable interrupt for event XOTUNEFAILED"]
    #[inline(always)]
    pub fn xotunefailed(&mut self) -> XotunefailedW<'_, IntensetSpec> {
