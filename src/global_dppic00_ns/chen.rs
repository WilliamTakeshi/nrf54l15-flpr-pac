...
impl W {
    ...
    #[doc = "Bit 10 - Enable or disable channel 10"]
    #[inline(always)]
    pub fn ch10(&mut self) -> Ch10W<'_, ChenSpec> {
        Ch10W::new(self, 10)
    }
    #[doc = "Bit 11 - Enable or disable channel 11"]
    #[inline(always)]
    pub fn ch11(&mut self) -> Ch11W<'_, ChenSpec> {
        Ch11W::new(self, 11)
    }
    #[doc = "Bit 12 - Enable or disable channel 12"]
    #[inline(always)]
    pub fn ch12(&mut self) -> Ch12W<'_, ChenSpec> {
        Ch12W::new(self, 12)
    }
    #[doc = "Bit 13 - Enable or disable channel 13"]
    #[inline(always)]
    pub fn ch13(&mut self) -> Ch13W<'_, ChenSpec> {
        Ch13W::new(self, 13)
    }
    #[doc = "Bit 14 - Enable or disable channel 14"]
    #[inline(always)]
    pub fn ch14(&mut self) -> Ch14W<'_, ChenSpec> {
        Ch14W::new(self, 14)
    }
    #[doc = "Bit 15 - Enable or disable channel 15"]
    #[inline(always)]
    pub fn ch15(&mut self) -> Ch15W<'_, ChenSpec> {
        Ch15W::new(self, 15)
    }
    #[doc = "Bit 16 - Enable or disable channel 16"]
    #[inline(always)]
    pub fn ch16(&mut self) -> Ch16W<'_, ChenSpec> {
        Ch16W::new(self, 16)
    }
    #[doc = "Bit 17 - Enable or disable channel 17"]
    #[inline(always)]
    pub fn ch17(&mut self) -> Ch17W<'_, ChenSpec> {
        Ch17W::new(self, 17)
    }
    #[doc = "Bit 18 - Enable or disable channel 18"]
    #[inline(always)]
    pub fn ch18(&mut self) -> Ch18W<'_, ChenSpec> {
        Ch18W::new(self, 18)
    }
    #[doc = "Bit 19 - Enable or disable channel 19"]
    #[inline(always)]
    pub fn ch19(&mut self) -> Ch19W<'_, ChenSpec> {
        Ch19W::new(self, 19)
    }
    #[doc = "Bit 20 - Enable or disable channel 20"]
    #[inline(always)]
