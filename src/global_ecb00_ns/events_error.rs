...
#[doc = "Field `EVENTS_ERROR` reader - ECB block encrypt aborted because of a STOP task or due to an error"]
...
#[doc = "Field `EVENTS_ERROR` writer - ECB block encrypt aborted because of a STOP task or due to an error"]
...
impl R {
    #[doc = "Bit 0 - ECB block encrypt aborted because of a STOP task or due to an error"]
    #[inline(always)]
