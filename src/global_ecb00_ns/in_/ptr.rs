...
#[doc = "Field `PTR` reader - Points to a job list containing unencrypted ECB data structure"]
pub type PtrR = crate::FieldReader<u32>;
#[doc = "Field `PTR` writer - Points to a job list containing unencrypted ECB data structure"]
pub type PtrW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Points to a job list containing unencrypted ECB data structure"]
    #[inline(always)]
