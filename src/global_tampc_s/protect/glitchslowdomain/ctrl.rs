...
#[doc = "Field `VALUE` reader - Set value of slow domain glitch detectors enable signal."]
...
#[doc = "Field `VALUE` writer - Set value of slow domain glitch detectors enable signal."]
...
impl R {
    #[doc = "Bit 0 - Set value of slow domain glitch detectors enable signal."]
    #[inline(always)]
