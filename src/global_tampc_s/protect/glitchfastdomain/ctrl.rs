...
#[doc = "Field `VALUE` reader - Set value of fast domain glitch detector's enable signal."]
...
#[doc = "Field `VALUE` writer - Set value of fast domain glitch detector's enable signal."]
...
impl R {
    #[doc = "Bit 0 - Set value of fast domain glitch detector's enable signal."]
    #[inline(always)]
