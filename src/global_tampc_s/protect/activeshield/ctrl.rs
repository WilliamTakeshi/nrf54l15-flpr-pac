...
#[doc = "Field `VALUE` reader - Set value of active shield enable signal."]
...
#[doc = "Field `VALUE` writer - Set value of active shield enable signal."]
...
impl R {
    #[doc = "Bit 0 - Set value of active shield enable signal."]
    #[inline(always)]
