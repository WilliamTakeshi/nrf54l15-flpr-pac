...
#[doc = "Field `VALUE` reader - Set value of internal tamper reset enable signal."]
...
#[doc = "Field `VALUE` writer - Set value of internal tamper reset enable signal."]
...
impl R {
    #[doc = "Bit 0 - Set value of internal tamper reset enable signal."]
    #[inline(always)]
