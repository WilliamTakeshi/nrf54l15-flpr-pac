...
#[doc = "Field `VALUE` reader - Set value of eraseprotect signal."]
...
#[doc = "Field `VALUE` writer - Set value of eraseprotect signal."]
...
impl R {
    #[doc = "Bit 0 - Set value of eraseprotect signal."]
    #[inline(always)]
