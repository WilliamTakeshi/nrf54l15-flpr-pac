...
impl Dppic {
    #[doc = "0x00..0x60 - Description collection: Security configuration for channel n of DPPIC"]
    #[inline(always)]
    ...
    #[doc = "0x60..0x80 - Description collection: Security configuration for channel group n of DPPIC"]
    #[inline(always)]
