...
impl Gpiote {
    #[doc = "0x00..0x20 - Description collection: Security configuration for channel o of GPIOTE\\[n\\]"]
    #[inline(always)]
    ...
    #[doc = "0x20..0x40 - Description collection: Security configuration for interrupt o of GPIOTE\\[n\\]"]
    #[inline(always)]
