#[doc = "Register `SYSCOUNTER` reader"]
pub type R = crate::R<SyscounterSpec>;
#[doc = "Register `SYSCOUNTER` writer"]
pub type W = crate::W<SyscounterSpec>;
#[doc = "SECATTR feature\n\nValue on reset: 1"]
...
impl W {
    #[doc = "Bit 4 - SECATTR feature"]
    #[inline(always)]
    pub fn secattr(&mut self) -> SecattrW<'_, SyscounterSpec> {
        SecattrW::new(self, 4)
    }
    #[doc = "Bit 8 - LOCK feature"]
    #[inline(always)]
    pub fn lock(&mut self) -> LockW<'_, SyscounterSpec> {
        LockW::new(self, 8)
    }
}
#[doc = "Security configuration for SYSCOUNTERL/SYSCOUNTERH of GRTC\n\nYou can [`read`](crate::Reg::read) this register and get [`syscounter::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`syscounter::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SyscounterSpec;
impl crate::RegisterSpec for SyscounterSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`syscounter::R`](R) reader structure"]
impl crate::Readable for SyscounterSpec {}
#[doc = "`write(|w| ..)` method takes [`syscounter::W`](W) writer structure"]
impl crate::Writable for SyscounterSpec {
    type Safety = crate::Unsafe;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0x0100;
}
#[doc = "`reset()` method sets SYSCOUNTER to value 0x0010_0010"]
impl crate::Resettable for SyscounterSpec {
