...
pub enum Securemapping {
    ...
    Secure = 1,
    #[doc = "2: Non-secure or secure attribute for this peripheral is defined by the PERIPH\\[n\\].PERM register"]
    UserSelectable = 2,
    #[doc = "3: This peripheral implements the split security mechanism."]
    Split = 3,
}
...
#[doc = "Field `SECUREMAPPING` reader - Read capabilities for TrustZone Cortex-M secure attribute"]
...
#[doc = "Field `DMA` reader - Read the peripheral DMA capabilities"]
...
pub enum Lock {
    ...
    Unlocked = 0,
    #[doc = "1: The content of this register can not be changed until the next reset"]
    Locked = 1,
}
...
#[doc = "Field `LOCK` reader - Register lock"]
...
impl LockR {
    ...
    #[doc = "The content of this register can not be changed until the next reset"]
    #[inline(always)]
    pub fn is_locked(&self) -> bool {
        *self == Lock::Locked
    }
}
#[doc = "Field `LOCK` writer - Register lock"]
...
#[doc = "Field `PRESENT` reader - Indicates if a peripheral is present with peripheral slave index n"]
...
impl R {
    #[doc = "Bits 0:1 - Read capabilities for TrustZone Cortex-M secure attribute"]
    #[inline(always)]
    pub fn securemapping(&self) -> SecuremappingR {
        SecuremappingR::new((self.bits & 3) as u8)
    }
    #[doc = "Bits 2:3 - Read the peripheral DMA capabilities"]
    #[inline(always)]
    ...
    #[doc = "Bit 31 - Indicates if a peripheral is present with peripheral slave index n"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 5 - Security attribution for the DMA transfer"]
    #[inline(always)]
    pub fn dmasec(&mut self) -> DmasecW<'_, PermSpec> {
        DmasecW::new(self, 5)
    }
    #[doc = "Bit 8 - Register lock"]
    #[inline(always)]
    pub fn lock(&mut self) -> LockW<'_, PermSpec> {
        LockW::new(self, 8)
    }
}
