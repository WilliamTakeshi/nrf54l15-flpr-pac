...
pub enum Mode {
    ...
    BleLr500kbit = 6,
    #[doc = "9: 4 Mbps Nordic proprietary radio mode (BT=0.6/h=0.5)"]
    Nrf4mbit0bt6 = 9,
    #[doc = "10: 4 Mbps Nordic proprietary radio mode (BT=0.4/h=0.5)"]
    Nrf4mbit0bt4 = 10,
...
impl ModeR {
    ...
    pub const fn variant(&self) -> Option<Mode> {
        match self.bits {
            ...
            9 => Some(Mode::Nrf4mbit0bt6),
            10 => Some(Mode::Nrf4mbit0bt4),
    ...
    #[inline(always)]
    pub fn is_nrf_4mbit_0bt6(&self) -> bool {
        *self == Mode::Nrf4mbit0bt6
    }
    #[doc = "4 Mbps Nordic proprietary radio mode (BT=0.4/h=0.5)"]
    #[inline(always)]
    pub fn is_nrf_4mbit_0bt4(&self) -> bool {
        *self == Mode::Nrf4mbit0bt4
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "4 Mbps Nordic proprietary radio mode (BT=0.6/h=0.5)"]
    #[inline(always)]
    pub fn nrf_4mbit_0bt6(self) -> &'a mut crate::W<REG> {
        self.variant(Mode::Nrf4mbit0bt6)
    }
    #[doc = "4 Mbps Nordic proprietary radio mode (BT=0.4/h=0.5)"]
    #[inline(always)]
    pub fn nrf_4mbit_0bt4(self) -> &'a mut crate::W<REG> {
        self.variant(Mode::Nrf4mbit0bt4)
    }
    #[doc = "IEEE 802.15.4-2006 250 kbps"]
    #[inline(always)]
