...
#[doc = "Field `EVENTS_END` reader - Memory access for packet data has been completed"]
...
#[doc = "Field `EVENTS_END` writer - Memory access for packet data has been completed"]
...
impl R {
    #[doc = "Bit 0 - Memory access for packet data has been completed"]
    #[inline(always)]
