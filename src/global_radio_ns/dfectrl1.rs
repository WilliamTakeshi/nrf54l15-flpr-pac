...
#[doc = "Field `REPEATPATTERN` reader - Repeat every antenna pattern N times."]
...
#[doc = "Field `REPEATPATTERN` writer - Repeat every antenna pattern N times."]
...
impl W {
    ...
    #[doc = "Bits 20:23 - Repeat every antenna pattern N times."]
    #[inline(always)]
    pub fn repeatpattern(&mut self) -> RepeatpatternW<'_, Dfectrl1Spec> {
