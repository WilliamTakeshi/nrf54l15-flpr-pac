...
impl crate::FieldSpec for S1incl {
    type Ux = u8;
}
impl crate::IsEnum for S1incl {}
#[doc = "Field `S1INCL` reader - Include or exclude S1 field in RAM"]
pub type S1inclR = crate::FieldReader<S1incl>;
impl S1inclR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<S1incl> {
        match self.bits {
            0 => Some(S1incl::Automatic),
            1 => Some(S1incl::Include),
            _ => None,
        }
    }
...
pub type S1inclW<'a, REG> = crate::FieldWriter<'a, REG, 2, S1incl>;
...
impl R {
    ...
    pub fn s1incl(&self) -> S1inclR {
        S1inclR::new(((self.bits >> 20) & 3) as u8)
    }
