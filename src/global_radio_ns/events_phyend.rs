...
#[doc = "Field `EVENTS_PHYEND` reader - The last bit is sent on air or last bit is received"]
...
#[doc = "Field `EVENTS_PHYEND` writer - The last bit is sent on air or last bit is received"]
