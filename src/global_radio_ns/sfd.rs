...
#[doc = "Field `SFD` reader - IEEE 802.15.4 start of frame delimiter. Note: the least significant 4 bits of the SFD cannot all be zeros."]
pub type SfdR = crate::FieldReader;
#[doc = "Field `SFD` writer - IEEE 802.15.4 start of frame delimiter. Note: the least significant 4 bits of the SFD cannot all be zeros."]
