...
pub enum Whiteoffset {
    #[doc = "0: S0 included in whitening"]
    Include = 0,
    #[doc = "1: S0 excluded from whitening"]
    Exclude = 1,
}
impl From<Whiteoffset> for bool {
    #[inline(always)]
    fn from(variant: Whiteoffset) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `WHITEOFFSET` reader - If whitening is enabled S0 can be configured to be excluded from whitening"]
pub type WhiteoffsetR = crate::BitReader<Whiteoffset>;
impl WhiteoffsetR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Whiteoffset {
        match self.bits {
            false => Whiteoffset::Include,
            true => Whiteoffset::Exclude,
        }
    }
    #[doc = "S0 included in whitening"]
    #[inline(always)]
    pub fn is_include(&self) -> bool {
        *self == Whiteoffset::Include
    }
    #[doc = "S0 excluded from whitening"]
    #[inline(always)]
    pub fn is_exclude(&self) -> bool {
        *self == Whiteoffset::Exclude
    }
}
#[doc = "Field `WHITEOFFSET` writer - If whitening is enabled S0 can be configured to be excluded from whitening"]
pub type WhiteoffsetW<'a, REG> = crate::BitWriter<'a, REG, Whiteoffset>;
impl<'a, REG> WhiteoffsetW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "S0 included in whitening"]
    ...
    pub fn include(self) -> &'a mut crate::W<REG> {
        self.variant(Whiteoffset::Include)
    }
    #[doc = "S0 excluded from whitening"]
    #[inline(always)]
    pub fn exclude(self) -> &'a mut crate::W<REG> {
        self.variant(Whiteoffset::Exclude)
    }
}
impl R {
    ...
    #[inline(always)]
    pub fn whiteoffset(&self) -> WhiteoffsetR {
        WhiteoffsetR::new(((self.bits >> 26) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:7 - Maximum length of packet payload. If the packet payload is larger than MAXLEN, the radio will truncate the payload to MAXLEN."]
    ...
    #[doc = "Bit 26 - If whitening is enabled S0 can be configured to be excluded from whitening"]
    #[inline(always)]
    pub fn whiteoffset(&mut self) -> WhiteoffsetW<'_, Pcnf1Spec> {
