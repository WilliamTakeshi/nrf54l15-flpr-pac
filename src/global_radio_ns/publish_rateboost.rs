...
pub type R = crate::R<PublishRateboostSpec>;
#[doc = "Register `PUBLISH_RATEBOOST` writer"]
pub type W = crate::W<PublishRateboostSpec>;
...
impl W {
    #[doc = "Bits 0:7 - DPPI channel that event RATEBOOST will publish to"]
    #[inline(always)]
    pub fn chidx(&mut self) -> ChidxW<'_, PublishRateboostSpec> {
        ChidxW::new(self, 0)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<'_, PublishRateboostSpec> {
        EnW::new(self, 31)
    }
}
#[doc = "Publish configuration for event RATEBOOST\n\nYou can [`read`](crate::Reg::read) this register and get [`publish_rateboost::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`publish_rateboost::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PublishRateboostSpec;
impl crate::RegisterSpec for PublishRateboostSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`publish_rateboost::R`](R) reader structure"]
impl crate::Readable for PublishRateboostSpec {}
#[doc = "`write(|w| ..)` method takes [`publish_rateboost::W`](W) writer structure"]
impl crate::Writable for PublishRateboostSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PUBLISH_RATEBOOST to value 0"]
impl crate::Resettable for PublishRateboostSpec {}
