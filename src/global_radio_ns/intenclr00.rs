#[doc = "Register `INTENCLR00` reader"]
pub type R = crate::R<Intenclr00Spec>;
#[doc = "Register `INTENCLR00` writer"]
pub type W = crate::W<Intenclr00Spec>;
...
impl R {
    ...
    #[doc = "Bit 1 - Write '1' to disable interrupt for event TXREADY"]
    #[inline(always)]
    pub fn txready(&self) -> TxreadyR {
        TxreadyR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Write '1' to disable interrupt for event RXREADY"]
    #[inline(always)]
    pub fn rxready(&self) -> RxreadyR {
        RxreadyR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Write '1' to disable interrupt for event ADDRESS"]
    #[inline(always)]
    pub fn address(&self) -> AddressR {
        AddressR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - Write '1' to disable interrupt for event FRAMESTART"]
    #[inline(always)]
    pub fn framestart(&self) -> FramestartR {
        FramestartR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - Write '1' to disable interrupt for event PAYLOAD"]
    #[inline(always)]
    pub fn payload(&self) -> PayloadR {
        PayloadR::new(((self.bits >> 5) & 1) != 0)
    }
    ...
    #[doc = "Bit 7 - Write '1' to disable interrupt for event PHYEND"]
    #[inline(always)]
    pub fn phyend(&self) -> PhyendR {
        PhyendR::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - Write '1' to disable interrupt for event DISABLED"]
    #[inline(always)]
    pub fn disabled(&self) -> DisabledR {
        DisabledR::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - Write '1' to disable interrupt for event DEVMATCH"]
    #[inline(always)]
    pub fn devmatch(&self) -> DevmatchR {
        DevmatchR::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - Write '1' to disable interrupt for event DEVMISS"]
    #[inline(always)]
    pub fn devmiss(&self) -> DevmissR {
        DevmissR::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - Write '1' to disable interrupt for event CRCOK"]
    #[inline(always)]
    pub fn crcok(&self) -> CrcokR {
        CrcokR::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - Write '1' to disable interrupt for event CRCERROR"]
    #[inline(always)]
    pub fn crcerror(&self) -> CrcerrorR {
        CrcerrorR::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 14 - Write '1' to disable interrupt for event BCMATCH"]
    #[inline(always)]
    pub fn bcmatch(&self) -> BcmatchR {
        BcmatchR::new(((self.bits >> 14) & 1) != 0)
    }
    ...
    #[doc = "Bit 21 - Write '1' to disable interrupt for event MHRMATCH"]
    #[inline(always)]
    pub fn mhrmatch(&self) -> MhrmatchR {
        MhrmatchR::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22 - Write '1' to disable interrupt for event SYNC"]
    #[inline(always)]
    pub fn sync(&self) -> SyncR {
        SyncR::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - Write '1' to disable interrupt for event CTEPRESENT"]
    #[inline(always)]
    pub fn ctepresent(&self) -> CtepresentR {
        CtepresentR::new(((self.bits >> 23) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Write '1' to disable interrupt for event READY"]
    #[inline(always)]
    pub fn ready(&mut self) -> ReadyW<'_, Intenclr00Spec> {
        ReadyW::new(self, 0)
    }
    #[doc = "Bit 1 - Write '1' to disable interrupt for event TXREADY"]
    #[inline(always)]
    pub fn txready(&mut self) -> TxreadyW<'_, Intenclr00Spec> {
        TxreadyW::new(self, 1)
    }
    #[doc = "Bit 2 - Write '1' to disable interrupt for event RXREADY"]
    #[inline(always)]
    pub fn rxready(&mut self) -> RxreadyW<'_, Intenclr00Spec> {
        RxreadyW::new(self, 2)
    }
    #[doc = "Bit 3 - Write '1' to disable interrupt for event ADDRESS"]
    #[inline(always)]
    pub fn address(&mut self) -> AddressW<'_, Intenclr00Spec> {
        AddressW::new(self, 3)
    }
    #[doc = "Bit 4 - Write '1' to disable interrupt for event FRAMESTART"]
    #[inline(always)]
    pub fn framestart(&mut self) -> FramestartW<'_, Intenclr00Spec> {
        FramestartW::new(self, 4)
    }
    #[doc = "Bit 5 - Write '1' to disable interrupt for event PAYLOAD"]
    #[inline(always)]
    pub fn payload(&mut self) -> PayloadW<'_, Intenclr00Spec> {
        PayloadW::new(self, 5)
    }
    #[doc = "Bit 6 - Write '1' to disable interrupt for event END"]
    #[inline(always)]
    pub fn end(&mut self) -> EndW<'_, Intenclr00Spec> {
        EndW::new(self, 6)
    }
    #[doc = "Bit 7 - Write '1' to disable interrupt for event PHYEND"]
    #[inline(always)]
    pub fn phyend(&mut self) -> PhyendW<'_, Intenclr00Spec> {
        PhyendW::new(self, 7)
    }
    #[doc = "Bit 8 - Write '1' to disable interrupt for event DISABLED"]
    #[inline(always)]
    pub fn disabled(&mut self) -> DisabledW<'_, Intenclr00Spec> {
        DisabledW::new(self, 8)
    }
    #[doc = "Bit 9 - Write '1' to disable interrupt for event DEVMATCH"]
    #[inline(always)]
    pub fn devmatch(&mut self) -> DevmatchW<'_, Intenclr00Spec> {
        DevmatchW::new(self, 9)
    }
    #[doc = "Bit 10 - Write '1' to disable interrupt for event DEVMISS"]
    #[inline(always)]
    pub fn devmiss(&mut self) -> DevmissW<'_, Intenclr00Spec> {
        DevmissW::new(self, 10)
    }
    #[doc = "Bit 11 - Write '1' to disable interrupt for event CRCOK"]
    #[inline(always)]
    pub fn crcok(&mut self) -> CrcokW<'_, Intenclr00Spec> {
        CrcokW::new(self, 11)
    }
    #[doc = "Bit 12 - Write '1' to disable interrupt for event CRCERROR"]
    #[inline(always)]
    pub fn crcerror(&mut self) -> CrcerrorW<'_, Intenclr00Spec> {
        CrcerrorW::new(self, 12)
    }
    #[doc = "Bit 14 - Write '1' to disable interrupt for event BCMATCH"]
    #[inline(always)]
    pub fn bcmatch(&mut self) -> BcmatchW<'_, Intenclr00Spec> {
        BcmatchW::new(self, 14)
    }
    #[doc = "Bit 15 - Write '1' to disable interrupt for event EDEND"]
    #[inline(always)]
    pub fn edend(&mut self) -> EdendW<'_, Intenclr00Spec> {
        EdendW::new(self, 15)
    }
    #[doc = "Bit 16 - Write '1' to disable interrupt for event EDSTOPPED"]
    #[inline(always)]
    pub fn edstopped(&mut self) -> EdstoppedW<'_, Intenclr00Spec> {
        EdstoppedW::new(self, 16)
    }
    #[doc = "Bit 17 - Write '1' to disable interrupt for event CCAIDLE"]
    #[inline(always)]
    pub fn ccaidle(&mut self) -> CcaidleW<'_, Intenclr00Spec> {
        CcaidleW::new(self, 17)
    }
    #[doc = "Bit 18 - Write '1' to disable interrupt for event CCABUSY"]
    #[inline(always)]
    pub fn ccabusy(&mut self) -> CcabusyW<'_, Intenclr00Spec> {
        CcabusyW::new(self, 18)
    }
    #[doc = "Bit 19 - Write '1' to disable interrupt for event CCASTOPPED"]
    #[inline(always)]
    pub fn ccastopped(&mut self) -> CcastoppedW<'_, Intenclr00Spec> {
        CcastoppedW::new(self, 19)
    }
    #[doc = "Bit 20 - Write '1' to disable interrupt for event RATEBOOST"]
    #[inline(always)]
    pub fn rateboost(&mut self) -> RateboostW<'_, Intenclr00Spec> {
        RateboostW::new(self, 20)
    }
    #[doc = "Bit 21 - Write '1' to disable interrupt for event MHRMATCH"]
    #[inline(always)]
    pub fn mhrmatch(&mut self) -> MhrmatchW<'_, Intenclr00Spec> {
        MhrmatchW::new(self, 21)
    }
    #[doc = "Bit 22 - Write '1' to disable interrupt for event SYNC"]
    #[inline(always)]
    pub fn sync(&mut self) -> SyncW<'_, Intenclr00Spec> {
        SyncW::new(self, 22)
    }
    #[doc = "Bit 23 - Write '1' to disable interrupt for event CTEPRESENT"]
    #[inline(always)]
    pub fn ctepresent(&mut self) -> CtepresentW<'_, Intenclr00Spec> {
        CtepresentW::new(self, 23)
    }
}
#[doc = "Disable interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`intenclr00::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`intenclr00::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Intenclr00Spec;
impl crate::RegisterSpec for Intenclr00Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`intenclr00::R`](R) reader structure"]
impl crate::Readable for Intenclr00Spec {}
#[doc = "`write(|w| ..)` method takes [`intenclr00::W`](W) writer structure"]
impl crate::Writable for Intenclr00Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets INTENCLR00 to value 0"]
impl crate::Resettable for Intenclr00Spec {}
