#[doc = "Register `INTENSET10` reader"]
pub type R = crate::R<Intenset10Spec>;
#[doc = "Register `INTENSET10` writer"]
pub type W = crate::W<Intenset10Spec>;
...
impl W {
    #[doc = "Bit 0 - Write '1' to enable interrupt for event READY"]
    #[inline(always)]
    pub fn ready(&mut self) -> ReadyW<'_, Intenset10Spec> {
        ReadyW::new(self, 0)
    }
    #[doc = "Bit 1 - Write '1' to enable interrupt for event TXREADY"]
    #[inline(always)]
    pub fn txready(&mut self) -> TxreadyW<'_, Intenset10Spec> {
        TxreadyW::new(self, 1)
    }
    #[doc = "Bit 2 - Write '1' to enable interrupt for event RXREADY"]
    #[inline(always)]
    pub fn rxready(&mut self) -> RxreadyW<'_, Intenset10Spec> {
        RxreadyW::new(self, 2)
    }
    #[doc = "Bit 3 - Write '1' to enable interrupt for event ADDRESS"]
    #[inline(always)]
    pub fn address(&mut self) -> AddressW<'_, Intenset10Spec> {
        AddressW::new(self, 3)
    }
    #[doc = "Bit 4 - Write '1' to enable interrupt for event FRAMESTART"]
    #[inline(always)]
    pub fn framestart(&mut self) -> FramestartW<'_, Intenset10Spec> {
        FramestartW::new(self, 4)
    }
    #[doc = "Bit 5 - Write '1' to enable interrupt for event PAYLOAD"]
    #[inline(always)]
    pub fn payload(&mut self) -> PayloadW<'_, Intenset10Spec> {
        PayloadW::new(self, 5)
    }
    #[doc = "Bit 6 - Write '1' to enable interrupt for event END"]
    #[inline(always)]
    pub fn end(&mut self) -> EndW<'_, Intenset10Spec> {
        EndW::new(self, 6)
    }
    #[doc = "Bit 7 - Write '1' to enable interrupt for event PHYEND"]
    #[inline(always)]
    pub fn phyend(&mut self) -> PhyendW<'_, Intenset10Spec> {
        PhyendW::new(self, 7)
    }
    #[doc = "Bit 8 - Write '1' to enable interrupt for event DISABLED"]
    #[inline(always)]
    pub fn disabled(&mut self) -> DisabledW<'_, Intenset10Spec> {
        DisabledW::new(self, 8)
    }
    #[doc = "Bit 9 - Write '1' to enable interrupt for event DEVMATCH"]
    #[inline(always)]
    pub fn devmatch(&mut self) -> DevmatchW<'_, Intenset10Spec> {
        DevmatchW::new(self, 9)
    }
    #[doc = "Bit 10 - Write '1' to enable interrupt for event DEVMISS"]
    #[inline(always)]
    pub fn devmiss(&mut self) -> DevmissW<'_, Intenset10Spec> {
        DevmissW::new(self, 10)
    }
    #[doc = "Bit 11 - Write '1' to enable interrupt for event CRCOK"]
    #[inline(always)]
    pub fn crcok(&mut self) -> CrcokW<'_, Intenset10Spec> {
        CrcokW::new(self, 11)
    }
    #[doc = "Bit 12 - Write '1' to enable interrupt for event CRCERROR"]
    #[inline(always)]
    pub fn crcerror(&mut self) -> CrcerrorW<'_, Intenset10Spec> {
        CrcerrorW::new(self, 12)
    }
    #[doc = "Bit 14 - Write '1' to enable interrupt for event BCMATCH"]
    #[inline(always)]
    pub fn bcmatch(&mut self) -> BcmatchW<'_, Intenset10Spec> {
        BcmatchW::new(self, 14)
    }
    #[doc = "Bit 15 - Write '1' to enable interrupt for event EDEND"]
    #[inline(always)]
    pub fn edend(&mut self) -> EdendW<'_, Intenset10Spec> {
        EdendW::new(self, 15)
    }
    #[doc = "Bit 16 - Write '1' to enable interrupt for event EDSTOPPED"]
    #[inline(always)]
    pub fn edstopped(&mut self) -> EdstoppedW<'_, Intenset10Spec> {
        EdstoppedW::new(self, 16)
    }
    #[doc = "Bit 17 - Write '1' to enable interrupt for event CCAIDLE"]
    #[inline(always)]
    pub fn ccaidle(&mut self) -> CcaidleW<'_, Intenset10Spec> {
        CcaidleW::new(self, 17)
    }
    #[doc = "Bit 18 - Write '1' to enable interrupt for event CCABUSY"]
    #[inline(always)]
    pub fn ccabusy(&mut self) -> CcabusyW<'_, Intenset10Spec> {
        CcabusyW::new(self, 18)
    }
    #[doc = "Bit 19 - Write '1' to enable interrupt for event CCASTOPPED"]
    #[inline(always)]
    pub fn ccastopped(&mut self) -> CcastoppedW<'_, Intenset10Spec> {
        CcastoppedW::new(self, 19)
    }
    #[doc = "Bit 20 - Write '1' to enable interrupt for event RATEBOOST"]
    #[inline(always)]
    pub fn rateboost(&mut self) -> RateboostW<'_, Intenset10Spec> {
        RateboostW::new(self, 20)
    }
    #[doc = "Bit 21 - Write '1' to enable interrupt for event MHRMATCH"]
    #[inline(always)]
    pub fn mhrmatch(&mut self) -> MhrmatchW<'_, Intenset10Spec> {
        MhrmatchW::new(self, 21)
    }
    #[doc = "Bit 22 - Write '1' to enable interrupt for event SYNC"]
    #[inline(always)]
    pub fn sync(&mut self) -> SyncW<'_, Intenset10Spec> {
        SyncW::new(self, 22)
    }
    #[doc = "Bit 23 - Write '1' to enable interrupt for event CTEPRESENT"]
    #[inline(always)]
    pub fn ctepresent(&mut self) -> CtepresentW<'_, Intenset10Spec> {
        CtepresentW::new(self, 23)
    }
}
#[doc = "Enable interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`intenset10::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`intenset10::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Intenset10Spec;
impl crate::RegisterSpec for Intenset10Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`intenset10::R`](R) reader structure"]
impl crate::Readable for Intenset10Spec {}
#[doc = "`write(|w| ..)` method takes [`intenset10::W`](W) writer structure"]
impl crate::Writable for Intenset10Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets INTENSET10 to value 0"]
impl crate::Resettable for Intenset10Spec {}
