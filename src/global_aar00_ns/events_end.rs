...
#[doc = "Field `EVENTS_END` reader - Address resolution procedure complete or ended due to an error"]
...
#[doc = "Field `EVENTS_END` writer - Address resolution procedure complete or ended due to an error"]
...
impl R {
    #[doc = "Bit 0 - Address resolution procedure complete or ended due to an error"]
    #[inline(always)]
