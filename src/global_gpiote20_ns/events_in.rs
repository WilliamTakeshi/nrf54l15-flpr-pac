...
#[doc = "Event from pin specified in CONFIG\\[n\\].PSEL\n\nValue on reset: 0"]
...
#[doc = "Field `EVENTS_IN` reader - Event from pin specified in CONFIG\\[n\\].PSEL"]
...
#[doc = "Field `EVENTS_IN` writer - Event from pin specified in CONFIG\\[n\\].PSEL"]
...
impl W {
    #[doc = "Bit 0 - Event from pin specified in CONFIG\\[n\\].PSEL"]
    #[inline(always)]
    pub fn events_in(&mut self) -> EventsInW<'_, EventsInSpec> {
