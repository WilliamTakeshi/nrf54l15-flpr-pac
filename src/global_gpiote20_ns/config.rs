...
impl R {
    ...
    #[doc = "Bits 4:8 - GPIO number associated with SET\\[n\\], CLR\\[n\\], and OUT\\[n\\] tasks and IN\\[n\\] event"]
    #[inline(always)]
    pub fn psel(&self) -> PselR {
        PselR::new(((self.bits >> 4) & 0x1f) as u8)
    }
    #[doc = "Bits 9:12 - Port number"]
    #[inline(always)]
    pub fn port(&self) -> PortR {
        PortR::new(((self.bits >> 9) & 0x0f) as u8)
    }
...
impl W {
    ...
    #[doc = "Bits 9:12 - Port number"]
    #[inline(always)]
    pub fn port(&mut self) -> PortW<'_, ConfigSpec> {
        PortW::new(self, 9)
    }
    #[doc = "Bits 16:17 - When In task mode: Operation to be performed on output when OUT\\[n\\] task is triggered. When In event mode: Operation on input that shall trigger IN\\[n\\] event."]
    #[inline(always)]
