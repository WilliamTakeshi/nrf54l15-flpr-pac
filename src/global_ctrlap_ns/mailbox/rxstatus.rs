...
pub enum Rxstatus {
    #[doc = "0: No data is pending in register RXDATA."]
    NoDataPending = 0,
    #[doc = "1: Data is pending in register RXDATA."]
    DataPending = 1,
}
...
impl RxstatusR {
    ...
    #[doc = "No data is pending in register RXDATA."]
    #[inline(always)]
    pub fn is_no_data_pending(&self) -> bool {
        *self == Rxstatus::NoDataPending
    }
    #[doc = "Data is pending in register RXDATA."]
    #[inline(always)]
