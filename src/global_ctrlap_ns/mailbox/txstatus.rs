...
pub enum Txstatus {
    #[doc = "0: No data is pending in register TXDATA."]
    NoDataPending = 0,
    #[doc = "1: Data is pending in register TXDATA."]
    DataPending = 1,
}
...
impl TxstatusR {
    ...
    #[doc = "No data is pending in register TXDATA."]
    #[inline(always)]
    pub fn is_no_data_pending(&self) -> bool {
        *self == Txstatus::NoDataPending
    }
    #[doc = "Data is pending in register TXDATA."]
    #[inline(always)]
