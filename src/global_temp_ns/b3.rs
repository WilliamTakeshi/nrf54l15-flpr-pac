...
pub type B3W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
impl R {
    #[doc = "Bits 0:11 - y-intercept of 4th piece wise linear function"]
    #[inline(always)]
    pub fn b3(&self) -> B3R {
        B3R::new((self.bits & 0x0fff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:11 - y-intercept of 4th piece wise linear function"]
    #[inline(always)]
    pub fn b3(&mut self) -> B3W<'_, B3Spec> {
        B3W::new(self, 0)
    }
}
...
#[doc = "`reset()` method sets B3 to value 0x0ff8"]
impl crate::Resettable for B3Spec {
    const RESET_VALUE: u32 = 0x0ff8;
}
