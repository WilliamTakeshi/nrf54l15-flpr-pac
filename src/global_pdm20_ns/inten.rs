...
#[doc = "Field `DMABUSERROR` reader - Enable or disable interrupt for event DMABUSERROR"]
...
#[doc = "Field `DMABUSERROR` writer - Enable or disable interrupt for event DMABUSERROR"]
pub type DmabuserrorW<'a, REG> = crate::BitWriter<'a, REG, Dmabuserror>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(Dmabuserror::Disabled)
    }
    #[doc = "Enable"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(Dmabuserror::Enabled)
    }
}
impl R {
...
impl W {
    ...
    #[doc = "Bit 4 - Enable or disable interrupt for event DMABUSERROR"]
    #[inline(always)]
    pub fn dmabuserror(&mut self) -> DmabuserrorW<'_, IntenSpec> {
