...
pub type R = crate::R<PublishFielddetectedSpec>;
#[doc = "Register `PUBLISH_FIELDDETECTED` writer"]
pub type W = crate::W<PublishFielddetectedSpec>;
...
impl W {
    #[doc = "Bits 0:7 - DPPI channel that event FIELDDETECTED will publish to"]
    #[inline(always)]
    pub fn chidx(&mut self) -> ChidxW<'_, PublishFielddetectedSpec> {
        ChidxW::new(self, 0)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<'_, PublishFielddetectedSpec> {
        EnW::new(self, 31)
    }
}
#[doc = "Publish configuration for event FIELDDETECTED\n\nYou can [`read`](crate::Reg::read) this register and get [`publish_fielddetected::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`publish_fielddetected::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PublishFielddetectedSpec;
impl crate::RegisterSpec for PublishFielddetectedSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`publish_fielddetected::R`](R) reader structure"]
impl crate::Readable for PublishFielddetectedSpec {}
#[doc = "`write(|w| ..)` method takes [`publish_fielddetected::W`](W) writer structure"]
impl crate::Writable for PublishFielddetectedSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PUBLISH_FIELDDETECTED to value 0"]
impl crate::Resettable for PublishFielddetectedSpec {}
