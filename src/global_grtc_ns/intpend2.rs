#[doc = "Register `INTPEND2` reader"]
pub type R = crate::R<Intpend2Spec>;
...
#[doc = "Pending interrupts\n\nYou can [`read`](crate::Reg::read) this register and get [`intpend2::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Intpend2Spec;
impl crate::RegisterSpec for Intpend2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`intpend2::R`](R) reader structure"]
impl crate::Readable for Intpend2Spec {}
#[doc = "`reset()` method sets INTPEND2 to value 0"]
impl crate::Resettable for Intpend2Spec {}
