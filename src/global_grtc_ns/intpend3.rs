#[doc = "Register `INTPEND3` reader"]
pub type R = crate::R<Intpend3Spec>;
...
#[doc = "Pending interrupts\n\nYou can [`read`](crate::Reg::read) this register and get [`intpend3::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Intpend3Spec;
impl crate::RegisterSpec for Intpend3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`intpend3::R`](R) reader structure"]
impl crate::Readable for Intpend3Spec {}
#[doc = "`reset()` method sets INTPEND3 to value 0"]
impl crate::Resettable for Intpend3Spec {}
