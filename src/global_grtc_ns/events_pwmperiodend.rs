...
#[doc = "Field `EVENTS_PWMPERIODEND` reader - Event on end of each PWM period"]
...
#[doc = "Field `EVENTS_PWMPERIODEND` writer - Event on end of each PWM period"]
...
impl R {
    #[doc = "Bit 0 - Event on end of each PWM period"]
    #[inline(always)]
