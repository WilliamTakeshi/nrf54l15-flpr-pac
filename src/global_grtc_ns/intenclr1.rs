#[doc = "Register `INTENCLR1` reader"]
pub type R = crate::R<Intenclr1Spec>;
...
impl W {
    #[doc = "Bit 0 - Write '1' to disable interrupt for event COMPARE\\[0\\]"]
    #[inline(always)]
    pub fn compare0(&mut self) -> Compare0W<'_, Intenclr1Spec> {
        Compare0W::new(self, 0)
    }
    #[doc = "Bit 1 - Write '1' to disable interrupt for event COMPARE\\[1\\]"]
    #[inline(always)]
    pub fn compare1(&mut self) -> Compare1W<'_, Intenclr1Spec> {
        Compare1W::new(self, 1)
    }
    #[doc = "Bit 2 - Write '1' to disable interrupt for event COMPARE\\[2\\]"]
    #[inline(always)]
    pub fn compare2(&mut self) -> Compare2W<'_, Intenclr1Spec> {
        Compare2W::new(self, 2)
    }
    #[doc = "Bit 3 - Write '1' to disable interrupt for event COMPARE\\[3\\]"]
    #[inline(always)]
    pub fn compare3(&mut self) -> Compare3W<'_, Intenclr1Spec> {
        Compare3W::new(self, 3)
    }
    #[doc = "Bit 4 - Write '1' to disable interrupt for event COMPARE\\[4\\]"]
    #[inline(always)]
    pub fn compare4(&mut self) -> Compare4W<'_, Intenclr1Spec> {
        Compare4W::new(self, 4)
    }
    #[doc = "Bit 5 - Write '1' to disable interrupt for event COMPARE\\[5\\]"]
    #[inline(always)]
    pub fn compare5(&mut self) -> Compare5W<'_, Intenclr1Spec> {
        Compare5W::new(self, 5)
    }
    #[doc = "Bit 6 - Write '1' to disable interrupt for event COMPARE\\[6\\]"]
    #[inline(always)]
    pub fn compare6(&mut self) -> Compare6W<'_, Intenclr1Spec> {
        Compare6W::new(self, 6)
    }
    #[doc = "Bit 7 - Write '1' to disable interrupt for event COMPARE\\[7\\]"]
    #[inline(always)]
    pub fn compare7(&mut self) -> Compare7W<'_, Intenclr1Spec> {
        Compare7W::new(self, 7)
    }
    #[doc = "Bit 8 - Write '1' to disable interrupt for event COMPARE\\[8\\]"]
    #[inline(always)]
    pub fn compare8(&mut self) -> Compare8W<'_, Intenclr1Spec> {
        Compare8W::new(self, 8)
    }
    #[doc = "Bit 9 - Write '1' to disable interrupt for event COMPARE\\[9\\]"]
    #[inline(always)]
    pub fn compare9(&mut self) -> Compare9W<'_, Intenclr1Spec> {
        Compare9W::new(self, 9)
    }
    #[doc = "Bit 10 - Write '1' to disable interrupt for event COMPARE\\[10\\]"]
    #[inline(always)]
    pub fn compare10(&mut self) -> Compare10W<'_, Intenclr1Spec> {
        Compare10W::new(self, 10)
    }
    #[doc = "Bit 11 - Write '1' to disable interrupt for event COMPARE\\[11\\]"]
    #[inline(always)]
    pub fn compare11(&mut self) -> Compare11W<'_, Intenclr1Spec> {
        Compare11W::new(self, 11)
    }
    #[doc = "Bit 25 - Write '1' to disable interrupt for event RTCOMPARESYNC"]
    #[inline(always)]
    pub fn rtcomparesync(&mut self) -> RtcomparesyncW<'_, Intenclr1Spec> {
        RtcomparesyncW::new(self, 25)
    }
    #[doc = "Bit 27 - Write '1' to disable interrupt for event PWMPERIODEND"]
    #[inline(always)]
    pub fn pwmperiodend(&mut self) -> PwmperiodendW<'_, Intenclr1Spec> {
        PwmperiodendW::new(self, 27)
    }
    #[doc = "Bit 29 - Write '1' to disable interrupt for event PWMREADY"]
    #[inline(always)]
    pub fn pwmready(&mut self) -> PwmreadyW<'_, Intenclr1Spec> {
        PwmreadyW::new(self, 29)
    }
    #[doc = "Bit 30 - Write '1' to disable interrupt for event CLKOUTREADY"]
    #[inline(always)]
    pub fn clkoutready(&mut self) -> ClkoutreadyW<'_, Intenclr1Spec> {
        ClkoutreadyW::new(self, 30)
    }
}
#[doc = "Disable interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`intenclr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`intenclr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Intenclr1Spec;
impl crate::RegisterSpec for Intenclr1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`intenclr1::R`](R) reader structure"]
impl crate::Readable for Intenclr1Spec {}
