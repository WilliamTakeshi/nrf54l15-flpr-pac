...
pub enum Enable {
    #[doc = "0: Disable the regulator"]
    Disabled = 0,
    #[doc = "1: Enable the regulator"]
    Enabled = 1,
}
...
#[doc = "Field `ENABLE` reader - Enable the regulator"]
...
#[doc = "Field `ENABLE` writer - Enable the regulator"]
...
impl R {
    #[doc = "Bit 0 - Enable the regulator"]
    #[inline(always)]
...
#[doc = "`reset()` method sets ENABLE to value 0x01"]
