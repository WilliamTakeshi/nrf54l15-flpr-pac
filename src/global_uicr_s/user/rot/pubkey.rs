...
impl Pubkey {
    #[doc = "0x00..0x20 - Description collection: First 256 bits of SHA2-512 digest over RoT public key generation \\[n\\]."]
    #[inline(always)]
    ...
    #[doc = "0x20..0x2c - Description collection: Revocation status for RoT public key generation \\[n\\]."]
    #[inline(always)]
