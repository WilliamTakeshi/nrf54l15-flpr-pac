...
#[doc = "Field `EN` reader - Subscription enable bit"]
...
#[doc = "Field `EN` writer - Subscription enable bit"]
...
impl W {
    #[doc = "Bit 31 - Subscription enable bit"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<'_, SubscribeTriggerSpec> {
        EnW::new(self, 31)
    }
}
...
#[doc = "`reset()` method sets SUBSCRIBE_TRIGGER[%s] to value 0"]
