...
#[doc = "Field `EVENTS_TRIGGERED` reader - VPR event \\[n\\] register"]
...
#[doc = "Field `EVENTS_TRIGGERED` writer - VPR event \\[n\\] register"]
...
impl R {
    #[doc = "Bit 0 - VPR event \\[n\\] register"]
    #[inline(always)]
