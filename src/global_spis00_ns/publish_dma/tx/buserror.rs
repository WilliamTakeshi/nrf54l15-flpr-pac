...
#[doc = "Field `CHIDX` reader - DPPI channel that event BUSERROR will publish to"]
pub type ChidxR = crate::FieldReader;
#[doc = "Field `CHIDX` writer - DPPI channel that event BUSERROR will publish to"]
...
impl R {
    #[doc = "Bits 0:7 - DPPI channel that event BUSERROR will publish to"]
    #[inline(always)]
