...
#[doc = "Field `EVENTS_END` reader - Encrypt/decrypt complete or ended because of an error"]
...
#[doc = "Field `EVENTS_END` writer - Encrypt/decrypt complete or ended because of an error"]
...
impl R {
    #[doc = "Bit 0 - Encrypt/decrypt complete or ended because of an error"]
    #[inline(always)]
