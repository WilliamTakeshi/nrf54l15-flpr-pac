...
pub enum Errorstatus {
    ...
    NoError = 0,
    #[doc = "1: End of INPTR job list before CCM data structure was read."]
    PrematureInptrEnd = 1,
    #[doc = "2: End of OUTPTR job list before CCM data structure was read."]
    PrematureOutptrEnd = 2,
    #[doc = "3: Encryption of the unencrypted CCM data structure did not complete in time."]
    EncryptionTooSlow = 3,
